...
// reader + the three composition rules + the search and fetch block builders,
// `blocksFromConfig`, `searchBlockFromConfig` and `fetchBlockFromConfig`), which is
...
// `config-core`.
//
// EXCLUDED on purpose: `readCredentials` (in telem-common.mjs — the hook
